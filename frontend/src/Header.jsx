function Header() {
  return (
    <header className="bg-gray-300 flex flex-col items-stretch">
      ...
      <div className="relative flex flex-wrap justify-center items-center gap-4 py-4">
        ...
        <div className="flex items-center justify-center">
          <button className="bg-lime-500 py-4 px-8 rounded-xl text-gray-800 font-semibold text-xl shadow-md hover:shadow-lg transition-transform duration-300 transform hover:scale-105">
